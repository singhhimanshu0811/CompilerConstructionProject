...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_PRIMITIVE = 36,                 /* PRIMITIVE  */
  YYSYMBOL_ENGINE = 37,                    /* ENGINE  */
  YYSYMBOL_FUNCTIONS = 38,                 /* FUNCTIONS  */
  YYSYMBOL_FUNCTION = 39,                  /* FUNCTION  */
  YYSYMBOL_BODY = 40,                      /* BODY  */
  YYSYMBOL_STATEMENT = 41,                 /* STATEMENT  */
  YYSYMBOL_IFSTATEMENT = 42,               /* IFSTATEMENT  */
  YYSYMBOL_WHILELOOP = 43,                 /* WHILELOOP  */
  YYSYMBOL_EXPR = 44,                      /* EXPR  */
  YYSYMBOL_ARITHLOGIC = 45,                /* ARITHLOGIC  */
  YYSYMBOL_TERM = 46,                      /* TERM  */
  YYSYMBOL_ARITH1 = 47,                    /* ARITH1  */
  YYSYMBOL_FACTOR = 48,                    /* FACTOR  */
  YYSYMBOL_TERM1 = 49,                     /* TERM1  */
...
static const yytype_int8 yytranslate[] =
{
       ...
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
      27,    28,    33,    29,     2,    30,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
      32,    22,    31,     2,     2,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
...
{
       0,    43,    43,    57,    63,    71,    77,    84,    90,    96,
     104,   110,   117,   123,   129,   135,   143,   150,   160,   169,
     175,   181,   189,   197,   204,   210,   216,   222,   228,   234,
     241,   244,   247,   250,   256,   260,   263,   266,   270,   278,
     284
};
#endif
...
{
      13,    12,    22,    16,   -84,     4,    32,    -2,    44,   -84,
     -84,    24,    -4,    51,   -84,     1,    -6,    33,    52,    -2,
      -2,    31,    16,     2,     2,     2,     2,     2,   -84,     2,
       2,   -84,    57,    61,    62,    27,    39,    53,   -84,   -84,
       1,     1,     1,     1,     1,    -6,    -6,    35,    69,    33,
      74,   -84,   -84,   -84,   -84,   -84,   -84,   -84,   -84,   -84,
     -84,    63,    56,    59,    -2,    58,    35,   -84,   -84,    64,
     -84,    66,    74,    -2,    -2,    -2,   -84,   -84,   -84,    70,
     -84,    -2,    74,    65,   -84,    67,    68,    40,   -84,   -84,
     -84,    81,    35,    74,   -84,    35,    80,    74,    82,    26,
     -84,    73,   -84,    35,   -84,    86,   -84
};
...
{
       0,     0,     0,     4,     1,     0,     0,     0,     0,    31,
      30,     0,     0,     0,    19,    29,    37,     8,     0,     0,
       0,     0,     4,     0,     0,     0,     0,     0,    22,     0,
       0,    23,     0,     0,     0,     0,     0,     0,    32,     3,
      29,    29,    29,    29,    29,    37,    37,     0,     0,     8,
       0,    20,    34,    33,    28,    24,    25,    26,    27,    36,
      35,     0,     0,     0,     0,     0,    11,    12,    13,     0,
       7,     0,    40,     0,     0,     0,    15,     9,    10,     0,
       2,     0,    40,     0,    14,     0,     0,     0,    38,    39,
      21,     0,     0,     0,     5,     0,     0,    40,     0,    11,
      18,     0,    16,     0,     6,     0,    17
};
...
{
     -84,   -84,    71,   -84,    50,   -84,   -46,   -83,   -84,   -84,
     -12,   -84,    47,    36,    11,     8,   -48,   -69
};

/* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
       0,     2,     6,    80,    33,    34,    78,    66,    67,    68,
      13,    14,    15,    28,    16,    31,    82,    83
};
...
{
      21,    65,    72,     9,    10,     9,    10,    36,    37,     9,
      10,    29,    99,    89,    19,    20,     1,    23,     3,    11,
     105,    11,     4,    12,     5,    12,     7,    30,   101,    12,
      24,    25,    26,    27,    61,    62,     8,   103,    18,    63,
      45,    46,    50,    61,    62,    97,    96,    64,    63,    98,
      17,    51,    76,    59,    60,    93,    64,    22,    32,    38,
      35,    84,    85,    86,    94,    47,    48,    52,    49,    88,
      40,    41,    42,    43,    44,    69,    54,    55,    56,    57,
      58,    53,    71,    74,    77,    73,    75,    79,    81,    90,
      87,    95,   100,    39,   102,    91,    92,   104,   106,    70
};

static const yytype_int8 yycheck[] =
{
      12,    47,    50,     7,     8,     7,     8,    19,    20,     7,
       8,    17,    95,    82,    18,    19,     3,    16,     6,    23,
     103,    23,     0,    27,     8,    27,    22,    33,    97,    27,
      29,    30,    31,    32,     8,     9,     4,    11,    14,    13,
      29,    30,    15,     8,     9,    93,    92,    21,    13,    95,
       6,    24,    64,    45,    46,    15,    21,     6,    25,    28,
       8,    73,    74,    75,    24,     8,     5,    28,     6,    81,
      23,    24,    25,    26,    27,     6,    40,    41,    42,    43,
      44,    28,     8,    27,    26,    22,    27,    23,    22,    24,
      20,    10,    12,    22,    12,    28,    28,    24,    12,    49
};
...
{
       0,     3,    35,     6,     0,     8,    36,    22,     4,     7,
       8,    23,    27,    44,    45,    46,    48,     6,    14,    18,
      19,    44,     6,    16,    29,    30,    31,    32,    47,    17,
      33,    49,    25,    38,    39,     8,    44,    44,    28,    36,
      46,    46,    46,    46,    46,    48,    48,     8,     5,     6,
      15,    24,    28,    28,    47,    47,    47,    47,    47,    49,
      49,     8,     9,    13,    21,    40,    41,    42,    43,     6,
      38,     8,    50,    22,    27,    27,    44,    26,    40,    23,
      37,    22,    50,    51,    44,    44,    44,    20,    44,    51,
      24,    28,    28,    15,    24,    10,    40,    50,    40,    41,
      12,    51,    12,    11,    24,    41,    12
};
...
#line 96 "grammar.y"
				...
				yyval = (ExtetricksSType)malloc(sizeof(xtetricksSType));
				yyval->value.StringValue = (char*)malloc(1024*sizeof(char));
				char* body = indent_proc(yyvsp[-1]->value.StringValue);
...
#line 129 "grammar.y"
				...
				yyval = (ExtetricksSType)malloc(sizeof(xtetricksSType)); 
				yyval->value.StringValue = (char*)malloc(1024*sizeof(char)); 
				sprintf(yyval->value.StringValue, "global %s\n%s = %s",yyvsp[-2]->value.StringValue, yyvsp[-2]->value.StringValue, yyvsp[0]->value.StringValue); 
...
#line 143 "grammar.y"
				...
				yyval = (ExtetricksSType)malloc(sizeof(xtetricksSType)); 
				yyval->value.StringValue = (char*)malloc(1024*sizeof(char)); 
				char* stm = indent_proc(yyvsp[-1]->value.StringValue);
...
#line 150 "grammar.y"
				...
				yyval = (ExtetricksSType)malloc(sizeof(xtetricksSType)); 
				yyval->value.StringValue = (char*)malloc(1024*sizeof(char)); 
				char* stm1 = indent_proc(yyvsp[-3]->value.StringValue);
				char* stm2 = indent_proc(yyvsp[-1]->value.StringValue);
...
#line 181 "grammar.y"
			...
			yyval = (ExtetricksSType)malloc(sizeof(xtetricksSType));
			yyval->value.StringValue = (char*)malloc(1024*sizeof(char));
			sprintf(yyval->value.StringValue, "%s(%s%s)", yyvsp[-4]->value.StringValue, yyvsp[-2]->value.StringValue, yyvsp[-1]->value.StringValue);
